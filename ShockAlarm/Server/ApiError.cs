...
public class ApiError
{
    ...
    public static readonly ApiError Unauthorized = new ApiError { Message = "Unauthorized" };
    public static readonly ApiError Forbidden = new ApiError { Message = "Forbidden" };
